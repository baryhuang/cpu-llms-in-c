...
| Qwen3.5-0.8B | Amlogic A113X: 4x Cortex-A53 | 2017 | runtime + tokenizer implemented, dev-verified | 12-case: image 10/12, BF16 10/12, agreement 8/12 (borderline cases); tokenizer parity 20/20; no target run | 9.16 tokens/s warm, 369 MiB RSS, x86 dev machine (informal) | [model](models/qwen3.5-0.8b/README.md) · [target](models/qwen3.5-0.8b/targets/a113x/README.md) |
