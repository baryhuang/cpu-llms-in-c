...
|---|---:|---:|---:|
| End-to-end throughput | 7.81 tok/s | **11.27 tok/s** | **1.44×** |
| Decode throughput | 7.92 tok/s | **11.58 tok/s** | **1.46×** |
| Long-code case end-to-end | 7.64 tok/s | **15.66 tok/s** | **2.05×** |
| Total request wall | 423.3 s | **303.6 s** | 119.7 s less |
