...
| Whisper small.en | Amlogic A113X: 4x Cortex-A53 | 2017 | mixed Q4/Q8 full graph; NEON encoder/decoder kernels and four-thread scheduling measured | public JFK smoke case normalized word edits 0/22; relative-WER suite remains open | 11 s WAV: **589.056 s, RTF 53.551**, 386% CPU, 327,820 KiB RSS, zero swap | [model](models/whisper-small.en/README.md) · [target](models/whisper-small.en/targets/a113x/README.md) · [review](models/whisper-small.en/targets/a113x/benchmarks/jfk-11s/REVIEW.html) · [raw data](models/whisper-small.en/targets/a113x/results.json) |
