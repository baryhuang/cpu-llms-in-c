...
|---|---:|---:|---:|---:|
| **End-to-end** | **6.54** | 6.06 | 3.96 | 3.74 |
...
at 63.6 tok/s (llama.cpp: 73.0). Longer mixed workloads reach
9.42 tok/s end-to-end; per-case records in the
[target file](models/qwen3.6-27b/targets/apple-m3-pro/README.md).
