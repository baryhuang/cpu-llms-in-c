...
| Qwen3.6-27B | Apple M3 Pro: 11-core CPU + 14-core Metal 3 GPU, 36 GB unified memory | 2023 | real layer-0 Q4 MLP through down/residual implemented; full graph open | source-BF16 oracle error below 6.3e-7 | **1.377035 ms**, **109.224 GB/s** complete MLP; gate/up path **1.1136x** vs internal generic layout; not model tokens/s or an oMLX comparison | [model](models/qwen3.6-27b/README.md) · [target](models/qwen3.6-27b/targets/apple-m3-pro/README.md) · [raw data](models/qwen3.6-27b/targets/apple-m3-pro/results.json) |
