...
| Whisper small.en | generic CPU | not pinned | complete 12-layer encoder; F32/Q4 image compiler and C loader | real-weight F32 stem/layer-0/final boundaries pass; Q4 error measured separately | decoder/tokenizer not implemented | [model](models/whisper-small.en/README.md) · [decision record](models/whisper-small.en/DECISIONS.md) · [generic target](models/whisper-small.en/targets/generic/README.md) |
| Whisper small.en-derived | Amlogic A113X: 4x Cortex-A53 | 2017 | Q4 encoder and cumulative A53 CPU kernels measured; structural reduction required | Q4 activation error finite; WER unavailable until decoder exists | 30 s encoder: **556.218 s, RTF 18.541**, 125,056 KiB RSS, zero swap | [model](models/whisper-small.en/README.md) · [target](models/whisper-small.en/targets/a113x/README.md) · [raw data](models/whisper-small.en/targets/a113x/results.json) |
