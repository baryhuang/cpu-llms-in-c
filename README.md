...
| MiniMind-O | Amlogic A113D/A113X, 4× Cortex-A53, 2 GB | native C11 SenseVoice → Thinker/Talker → stateful Mimi, Q8 + NEON + OpenMP | Four-core full-path speedup **2.98×**; Mimi 8-frame decode **7.80 → 1.26 s (6.19×)**; layer-batched prefill saves **646 ms**; physical ALSA streaming has zero underrun at a 75% buffer | [model](models/minimind-o/README.md) · [target](models/minimind-o/targets/a113x/README.md) · [raw results](models/minimind-o/targets/a113x/results.json) |
