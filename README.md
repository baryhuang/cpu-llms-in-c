...
| Whisper small.en | Amlogic A113X: 4x Cortex-A53 | 2017 | mixed Q4/Q8 full graph; compact window, NEON encoder/decoder kernels and four-thread scheduling measured | public JFK smoke case normalized word edits 0/22; relative-WER suite remains open | 11 s WAV, 3-run median: **48.215 s, RTF 4.383**, 388% CPU, 251,496 KiB RSS, zero swap; **12.22x** vs fixed30 | [model](models/whisper-small.en/README.md) · [target](models/whisper-small.en/targets/a113x/README.md) · [review](models/whisper-small.en/targets/a113x/benchmarks/jfk-11s/REVIEW.html) · [raw data](models/whisper-small.en/targets/a113x/results.json) |
