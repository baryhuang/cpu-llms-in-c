...
kernel void qwen36_rmsnorm_f16_to_f16(
...
kernel void qwen36_rmsnorm_f32_to_f16(
...
kernel void qwen36_q4_delta_inputs(
    device const half *input [[buffer(0)]],
...
kernel void qwen36_delta_causal_conv_silu(
...
kernel void qwen36_delta_prepare(
...
kernel void qwen36_delta_gated_rmsnorm(
...
kernel void qwen36_q4_delta_output_residual(
    device const float *input [[buffer(0)]],
    device const uchar *quants [[buffer(1)]],
    device const Q4LayerMeta *metadata [[buffer(2)]],
...
kernel void qwen36_q4_mlp_down_residual_f32(
    device const float *input [[buffer(0)]],
    device const uchar *quants [[buffer(1)]],
    device const Q4LayerMeta *metadata [[buffer(2)]],
