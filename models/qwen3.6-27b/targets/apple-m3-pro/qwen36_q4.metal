...
kernel void qwen36_q4_interleaved_matvec(
...
kernel void qwen36_q4_matvec(device const half *x [[buffer(0)]],
...
kernel void qwen36_q4_gate_up_silu(device const half *x [[buffer(0)]],
...
kernel void qwen36_q4_down_residual(device const float *intermediate [[buffer(0)]],
                                    device const uchar *quants [[buffer(1)]],
                                    device const Q4Meta *metadata [[buffer(2)]],
